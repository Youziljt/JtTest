package com.example.engineeringmode.widget.givelike;
...
public class PeriscopeLayout extends RelativeLayout {
    ...
    private android.view.animation.Interpolator line = new LinearInterpolator();//线性
    private android.view.animation.Interpolator acc = new AccelerateInterpolator();//加速
    private android.view.animation.Interpolator dce = new DecelerateInterpolator();//减速
    private android.view.animation.Interpolator accdec = new AccelerateDecelerateInterpolator();//先加速后减速
    ...
    private void init() {
        ...
        Drawable yellow = getResources().getDrawable(R.drawable.heart6);
        Drawable blue = getResources().getDrawable(R.drawable.heart8);
...
//        interpolators[0] = (Interpolator) line;
//        interpolators[1] = (Interpolator) acc;
//        interpolators[2] = (Interpolator) dce;
//        interpolators[3] = (Interpolator) accdec;
